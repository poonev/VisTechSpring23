...
let promise = [d3.csv("./data/ufo.csv")];
...
function drawScatterPlot(data) {
    ...
    */
    ...
    const latitude = {
        min: d3.min(filtered_data, function(d) { return +d.latitude; }),
        max: d3.max(filtered_data, function(d) { return +d.latitude; })
    };

    const longitude = {
        min: d3.min(filtered_data, function(d) { return +d.longitude; }),
        max: d3.max(filtered_data, function(d) { return +d.longitude; })
    };
    ...
    */
    ...
    const xScale = d3.scaleLinear()
        .domain([latitude.min, latitude.max])
    ...
    */
    ...
    points.on("mouseover", function(e, d) {
        ...
        let displayValue = d3.format(",")(d.durationseconds);
        ...
        tooltip.style("visibility", "visible")
            ...
            .html(`<p><b>${d.city}</b><br><em>${d.state}</em><br>#: ${displayValue}</p>`);
